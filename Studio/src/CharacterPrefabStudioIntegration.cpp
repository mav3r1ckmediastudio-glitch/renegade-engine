...
namespace renegade::studio
{
        ...
        std::string& status)
    {
        ...
        // The current browser reveal contract requires the caller to provide
        // a verified catalogue snapshot. This save path has no such snapshot;
        // retain the successful governed save and let the normal browser refresh
        // reveal the prefab instead of using the obsolete three-argument API.
