...
require_text(command_header "wi::ecs::Entity* createdSun" "atomic Environment and Sun creation")
require_text(studio_source "bridge::CaptureWeather(" "non-destructive live atmosphere recovery")
require_text(studio_source "std::make_unique<bridge::CreateSunCommand>" "Weather-only Level Sun recovery")
...
foreach(map IN ITEMS basecolor normal surface)
    require_text(terrain_source "default_grass_${map}.tga" "validated TGA ${map} runtime binding")
...
endforeach()
reject_text(terrain_source "default_grass_basecolor.dds" "truncated DDS default runtime binding")
require_text(studio_cmake "RenegadeTerrainSurfacePacker" "Studio terrain surface packer")
require_text(runtime_cmake "RenegadeTerrainSurfacePacker" "Runtime terrain surface packer")
